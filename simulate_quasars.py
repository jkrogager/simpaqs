...
def add_quasar_continuum(templates, output_dir='quasar_models'):
    """
    ...
    subset = qsos.data['ID', 'z', 'absMag', 'smcDustEBV', 'LOG_MBH', 'LOG_REDD', 'ABS_TEMP']
...
def main():
    ...
    parser.add_argument("templates", type=str,
                        help="List of absorber templates (list_templates.csv)")
    parser.add_argument("-n", "--number", type=int, default=3,
                        help="Number of random quasar realizations per absorber [default=3]")
    parser.add_argument("--dir", type=str, default='quasar_models',
                        help="Output directory [default=quasar_models]")
    ...
    for _ in range(args.number):
        ...
        add_quasar_continuum(templates, output_dir=args.dir)
